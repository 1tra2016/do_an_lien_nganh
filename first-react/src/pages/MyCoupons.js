...
import { userCouponAPI } from '../APIs/APIs';
...
const MyCoupons = () => {
    ...
    const removeCoupon = async (couponId) => {
        try {
            // Gọi DELETE endpoint để xóa coupon khỏi user
            // TODO: Cần thêm endpoint DELETE /{userId}/coupons/{couponId} từ backend
            await userCouponAPI.delete(`/${user.id}/coupons/${couponId}`);
    ...
    return (
        <div>
            <Myheader />
        <div className="mycoupons-page" >
            <div className="mycoupons-container" style ={{ marginBottom: '50px' }} >
